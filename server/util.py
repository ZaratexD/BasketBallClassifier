...
# should work but for some reason ./ isn't working so use server/
...
if __name__ == "__main__":
    ...
    for img in os.scandir("server/test_images"):
        if img.path.split(".")[-1] == "jpg" or img.path.split(".")[-1] == "png":
            print(classify_image(None, img.path))
